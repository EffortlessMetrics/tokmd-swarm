...
- `docs/review-packet.md` now defines the planned treatment for `tokmd.doc_artifacts_check.v1` as documentation-control evidence in future cockpit review packets, without adding a cockpit import path or changing merge behavior.
