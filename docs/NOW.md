...
Evidence snapshot: `2026-08-12T07:35:35Z` UTC. Exact heads and the linked PR
...
| [#574](https://github.com/EffortlessMetrics/tokmd-swarm/pull/574) | `da86d4349aff97b52204b7f7183dd0da4a4304d1` | Main-based promotion of the preserved terminal release-preflight contract/workflow plus the proven bounded cache prerequisite; local targeted formatting/actionlint/diff/affected-scope checks pass; first hosted run found and was corrected for rustfmt, unknown proof scopes, and pinned-cache contract compatibility | Focused Cargo tests/contract are unavailable after local timeouts; hosted rerun status is pending/unverified during GitHub API rate limiting; no publication or merge claim |
