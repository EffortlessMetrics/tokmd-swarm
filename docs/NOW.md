...
| --- | --- | --- | --- |
| [#545](https://github.com/EffortlessMetrics/tokmd-swarm/pull/545) | `b82c3c390e077179b410cba70cd53541046f8134` | First-hour inspect → review → evidence → handoff UX plus canonical single-maintainer/agentic-review policy; exact-head Tokmd Rust Result, Docs, cockpit, affected/fast, ripr, and policy checks pass; review threads resolved | Merge-ready by source and proof; stale external `Codex Review Gate` still blocks merge; no protection mutation |
...
| [#571](https://github.com/EffortlessMetrics/tokmd-swarm/pull/571) | `c4192b04d405a3372141d6e326d849777b2cc8ab` | 1.15.0 packet/container narrative anchored to the release ledger, exact digest, and consumer run `30965258655`; duplicated lead article removed and current review thread resolved; exact-head docs/supporting checks pass while Rust/Droid/ripr/Cockpit remain pending | Documentation only; exact-head hosted proof is incomplete; full release readiness is not claimed |
