...
Evidence snapshot: `2026-08-12T07:00:16Z` UTC. Exact heads and the linked PR
...
| [#574](https://github.com/EffortlessMetrics/tokmd-swarm/pull/574) | `0e85984155f737ef7b28af8103f5520250c3a36d` | Main-based promotion of the preserved terminal release-preflight contract/workflow; local actionlint and diff checks pass; hosted exact-head proof is in progress; 0 unresolved threads at opening | Full Cargo formatting was unavailable under local Windows contention; no publication or merge claim |
