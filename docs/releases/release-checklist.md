...
- publish exact release assets and crates in dependency order;
- verify the exact stable container and Action ref;
- move mutable aliases only after exact artifacts and crates publication pass.
